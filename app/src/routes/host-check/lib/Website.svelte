...
<style lang="postcss">
  ...
  scrollbar-color: #0b215c #2d3748; /* thumb and track color */
}
...
*::-webkit-scrollbar-thumb {
  background-color: #0b215c; /* color of the scroll thumb */
  border-radius: 20px; /* roundness of the scroll thumb */
  border: 3px solid #2d3748; /* creates padding around scroll thumb */
  @apply transition;
}

/* Optional: Styles for hover over the scrollbar thumb */
*::-webkit-scrollbar-thumb:hover {
  background-color: #103089; /* darker shade of thumb for hover state */
}
</style>